...
*/}
  ...
  return (
    <div className="bg-white">
      <div>
      <p className="flex h-10 items-center justify-center bg-beige-dark px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
          Get free delivery on orders over $59.99
        </p>
